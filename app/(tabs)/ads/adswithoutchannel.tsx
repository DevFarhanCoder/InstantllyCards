...
const getApiBaseUrl = () => {
  ...
  const prefix = Constants.expoConfig?.extra?.EXPO_PUBLIC_API_PREFIX || "/api";
  return `${base}${prefix}`;
};
...
export default function AdsWithoutChannel() {
  ...
  const [needsVideoResize, setNeedsVideoResize] = useState<
    "bottom" | "fullscreen" | null
  >(null);
  ...
  const pickVideo = async (type: "bottom" | "fullscreen") => {
    ...
    if (!result.canceled && result.assets[0]) {
      ...
      if (widthMatch && heightMatch) {
        ...
        Alert.alert(
          "✅ Video Accepted!",
          `Your video is the correct size (${requiredSize} pixels).`,
        );
      } else {
  ...
  const submitAdConfirmed = async () => {
    ...
    try {
      ...
      console.log(
        "📦 FormData fields: title, phoneNumber, uploaderPhone, userId, startDate, endDate",
      );
  ...
  const loadMyAds = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `${API_BASE_URL}/channel-partner/ads?phone=${userPhone}`,
      );
      const data = await response.json();
          ...
          <View style={styles.creditsCard}>
            ...
            {creditsLoading ? (
              ...
              <Text style={styles.creditsValue}>
                {formatIndianNumber(userCredits)}
              </Text>
            )}
          </View>
            ...
            <>
              <View style={styles.formGroup}>
                <View style={styles.mediaTypeLabelRow}>
                  ...
                  <Text style={styles.label}>
                    {" "}
                    Bottom Banner Image * (624×174px)
                  </Text>
                </View>
                <Text style={styles.hint}>
                  This image appears in the bottom carousel. Recommended size:
                  624 × 174 pixels
                </Text>
                <TouchableOpacity
              ...
              <View style={styles.formGroup}>
                <View style={styles.mediaTypeLabelRow}>
                  ...
                  <Text style={styles.label}>
                    {" "}
                    Fullscreen Image (Optional 624×1000px)
                  </Text>
                </View>
                <View style={styles.optionalInfoCard}>
                  ...
                  <Text style={styles.optionalInfoText}>
                    If not provided, users will see Call/Message buttons when
                    they tap the banner.
                  </Text>
                </View>
                <Text style={styles.hint}>
                  This image appears when user taps the bottom banner.
                ...
                >
                  {fullscreenImage ? (
                    ...
                    <>
                      ...
                      />
                      <Text style={styles.imagePickerText}>
                        Tap to Select Fullscreen Image
                      </Text>
                      <Text style={styles.imagePickerHint}>
                        or click to browse
                      </Text>
            ...
            <>
              <View style={styles.formGroup}>
                <View style={styles.mediaTypeLabelRow}>
                  ...
                  <Text style={styles.label}>
                    {" "}
                    Bottom Banner Video * (624×174px)
                  </Text>
                </View>
                <Text style={styles.hint}>
                  This video appears in the bottom carousel. Recommended: MP4
                  format, max 50MB
                </Text>
                <TouchableOpacity
                  style={[
                    styles.videoUploadCard,
                    bottomVideo && styles.videoUploadCardSelected,
                  ]}
                  ...
                  {bottomVideo ? (
                    <View style={styles.videoSelectedCard}>
                      ...
                      <View style={styles.videoSelectedDetails}>
                        ...
                        <Text style={styles.videoSelectedSize}>
                          {bottomVideo.width}×{bottomVideo.height} pixels
                        </Text>
                        <Text
                          style={styles.videoCardFileName}
                          numberOfLines={1}
                        >
                    ...
                    <View style={styles.videoUploadContent}>
                      ...
                      <Text style={styles.videoUploadHint}>
                        Must be exactly 624×174 pixels
                      </Text>
                    </View>
                  )}
                </TouchableOpacity>
              ...
              <View style={styles.formGroup}>
                <View style={styles.mediaTypeLabelRow}>
                  ...
                  <Text style={styles.label}>
                    {" "}
                    Fullscreen Video (Optional 624×1000px)
                  </Text>
                </View>
                <View style={styles.optionalInfoCard}>
                  <Ionicons
                ...
                <TouchableOpacity
                  style={[
                    styles.videoUploadCard,
                    styles.videoUploadCardTall,
                    fullscreenVideo && styles.videoUploadCardSelected,
                  ]}
                  ...
                  {fullscreenVideo ? (
                    <View style={styles.videoSelectedCard}>
                      ...
                      <View style={styles.videoSelectedDetails}>
                        ...
                        <Text style={styles.videoSelectedSize}>
                          {fullscreenVideo.width}×{fullscreenVideo.height}{" "}
                          pixels
                        </Text>
                        <Text
                          style={styles.videoCardFileName}
                    ...
                    <View style={styles.videoUploadContent}>
                      ...
                      <Text
                        style={[styles.videoUploadTitle, { color: "#6b7280" }]}
                      >
                        Upload Fullscreen Video
                      </Text>
                      <Text style={styles.videoUploadHint}>
                        Must be exactly 624×1000 pixels
                      </Text>
                    </View>
                  )}
                </TouchableOpacity>
                <Text style={styles.hint}>
                  This video appears when user taps the bottom banner.
          ...
          {adType === "video" && (
            <View style={styles.videoHelpCard}>
              ...
              <Text style={styles.videoHelpDesc}>
                Don't worry! Send us your video and we'll resize it to exact
                dimensions for FREE.
              </Text>
              <View style={styles.videoHelpActions}>
                <TouchableOpacity
                  ...
                  onPress={() =>
                    Linking.openURL(
                      "https://wa.me/919820329571?text=Hi%21%20I%20need%20help%20resizing%20my%20video%20for%20ads.%20Please%20assist%20me.",
                    )
                  }
                >
          ...
          {isLoadingAds ? (
            ...
            <View style={styles.emptyContainer}>
              ...
              <Text style={styles.emptySubtext}>
                Create your first ad in the Create tab
              </Text>
            </View>
          ) : (
            myAds.map((ad, index) => (
              <View key={ad.id} style={styles.adCard}>
                <View style={styles.adHeader}>
                  ...
                  >
                    <Ionicons
                      name={getStatusIcon(ad.status) as any}
                      size={14}
                      color="#fff"
                    />
                ...
                {ad.status === "approved" && (
                  ...
                  >
                    ...
                    />
                    <Text
                      style={[styles.pendingNoticeText, { color: "#065f46" }]}
                    >
                      Live in app
                    </Text>
                  </View>
                ...
                {ad.status === "rejected" && (
                  ...
                  >
                    ...
                    <Text
                      style={[styles.pendingNoticeText, { color: "#991b1b" }]}
                    >
